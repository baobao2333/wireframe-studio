...
if (values.help) {
  console.log("node scripts/package-desktop.mjs\nBuild dist-renderer first. Stages production dependencies and builds the Windows x64 NSIS installer without publishing. Only the trusted public key is required.");
} else {
  try {
